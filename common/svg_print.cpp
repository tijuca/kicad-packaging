...
////@begin WinEDA_PrintSVGFrame content construction
    // Generated by DialogBlocks, 05/02/2006 16:14:02 (unregistered)
    ...
    m_ButtPenWidth = new wxSpinCtrl( itemDialog1, ID_SPINCTRL, _T("0"), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 10, 100, 0 );
    ...
    wxButton* itemButton12 = new wxButton( itemDialog1, ID_PRINT_EXECUTE, _("Create &File"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    itemButton13->SetForegroundColour(wxColour(0, 0, 198));
    ...
    wxStaticText* itemStaticText17 = new wxStaticText( itemDialog1, wxID_STATIC, _("Messages:"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer2->Add(itemStaticText17, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT|wxTOP|wxADJUST_MINSIZE, 5);
...
BASE_SCREEN *oldscreen = screen;
	...
	if ( Select_PrintAll && m_Parent->m_Ident == SCHEMATIC_FRAME )
	{
		...
		while ( screen )
		{
			m_Parent->m_CurrentScreen = screen;
			ActiveScreen = screen;
