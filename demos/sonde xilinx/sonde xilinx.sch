...
LIBS:power,device,conn,linear,regul,74xx,cmos4000,adc-dac,memory,xilinx,special,microcontrollers,microchip,microchip1,analog_switches,motorola,intel,audio,interface,digital-audio,philips,display,cypress,siliconi,contrib
EELAYER 23  0
EELAYER END
$Descr A4 11700 8267
Sheet 1 1
...
U 1 1 3EBF81B1
P 6300 4650
F 0 "#PWR6" H 6300 4650 40  0001 C C
...
U 1 1 3EBF848F
P 6200 1050
F 0 "#FLG2" H 6200 1320 30  0001 C C
...
U 1 1 3EBF8479
P 5900 1050
F 0 "#PWR14" H 5900 1150 30  0001 C C
...
U 1 1 3EBF8458
P 800 7300
F 0 "#PWR13" H 800 7300 40  0001 C C
...
U 1 1 3EBF843C
P 800 7300
F 0 "#FLG1" H 800 7570 30  0001 C C
...
U 1 1 3EBF8100
P 2500 2750
F 0 "#PWR3" H 2500 2750 40  0001 C C
...
U 1 1 3EBF8376
P 10050 3600
F 0 "#PWR12" H 10050 3600 40  0001 C C
...
U 1 1 3EBF8376
P 8500 2650
F 0 "#PWR11" H 8500 2650 40  0001 C C
...
U 1 1 3EBF82CF
P 6500 1500
F 0 "#PWR10" H 6500 1500 40  0001 C C
...
U 1 1 3EBF81B1
P 6300 3750
F 0 "#PWR5" H 6300 3750 40  0001 C C
...
U 1 1 3EBF81B1
P 6300 3050
F 0 "#PWR7" H 6300 3050 40  0001 C C
...
U 1 1 3EBF81B3
P 6200 1600
F 0 "#PWR9" H 6200 1600 40  0001 C C
...
U 1 1 3EBF81B1
P 6300 2350
F 0 "#PWR8" H 6300 2350 40  0001 C C
...
U 1 1 3EBF8100
P 2500 1750
F 0 "#PWR4" H 2500 1750 40  0001 C C
...
U 1 1 3EBF80DD
P 4650 2000
F 0 "#PWR2" H 4650 2000 40  0001 C C
...
U 1 1 3EBF7F0D
P 1150 7300
F 0 "#PWR1" H 1150 7300 40  0001 C C
...
F 1 "DB25" H 1700 1450 70  0000 C C
	1    1750 2800
	-1   0    0    -1  
$EndComp
$EndSCHEMATC
